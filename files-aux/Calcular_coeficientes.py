...
if __name__ == "__main__":
    l_max = int(input('lmax = '))
    Body_name = input('Body Name: ')
    ...
    if not check_body_file_exists(l_max, Body_name):
        ...
        print('getting vertices and faces SH....')
        VERT_SH, FACES = get_Vertices_Faces(f'{Body_name}-lmax{l_max}')
        print('vertices & faces SH acquired')
